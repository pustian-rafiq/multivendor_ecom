        ...
        <form class="form-horizontal" method="post" action="{{ route('banner.update',$banner->id) }}">
          ...
          <div class="card-body">
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" name="title" value="{{ $banner->title }}" class="form-control" id="inputEmail3" >
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <div class="input-group">
                  ...
                  <input  class="form-control" type="hidden" name="old_photo" value="{{ $banner->photo }}">
                </div>
                <img src="{{ $banner->photo }}" width="70" height="70" />
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <select class="form-control" name="condition">
                  ...
                  <option value="banner" {{ ('banner') == 'banner' ? 'selected' : ''}}>Banner</option>
                  <option value="promo" {{  ('promo') =='promo' ? 'selected' : ''}}>Promote</option>
                </select>
              </div>
            </div>
